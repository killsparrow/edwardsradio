...
export default function Underwater() {
  return (
    <main className="bg-[#2f303b] relative">
        ...
        <div className="w-[90%] mx-auto bg-[#24252d]/70 sm: mt-48 md:mt-108 p-10">
          ...
          <LyricsAccordion>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-4">
                ...
                <p className="text-white">
                  ...
                  <br />
                  And I don't know what's worse, that it was paid for, or that
                  it works.
                </p>
                <p className="text-white">
                ...
                <p className="text-white">
                  I know, I know, the sky is taken away.
                  <br />I know, I know, I'm to blame. I'm to blame.
                </p>
                <p className="text-white">
                  And I don't know what's worse, that it was paid for or that it
                  works.
                </p>
              </div>
              ...
              <div className="p-4">
                ...
                <p className="text-white">
                  In the place I used to wait for you, at the table. At the
                  table.
                  <br />
                ...
                <p className="text-white">
                  In the place she used to fade away, staring through the
                  cracks.
                  <br />
                  Hey light, hey life.
                  <br />
                  In the place she used to waste away, falling through the
                  cracks.
                  <br />
                  Hey light, hey life.
                </p>
                <p className="text-white">
                  In this place we used to wait all day, at the table. At the
                  table.
                </p>
                <p className="text-white">
                ...
                <p className="text-white">
                  In the place she used to fade away, falling through the
                  cracks.
                  <br />
                  Hey life, hey light.
                  <br />
                  In this place she used to waste away, falling through the
                  cracks.
                  <br />
                  Hey light, hey life.
                </p>
              ...
              <div className="p-4">
                ...
                <p className="text-white">
                  I don't mind, I'll be yours anytime that you want me to be
                  there for you.
                  <br />
              ...
              <div className="p-4">
                ...
                <p className="text-white">
                  ...
                  <br />
                  Did you lose your mind? I think you got it, pretty well
                  figured out.
                </p>
                <p className="text-white">I think you got it, figured out.</p>
                <p className="text-white">
                  ...
                  since I was a child.
                  <br />I never listened to what they told me to do, and I fell
              ...
              <div className="p-4">
                ...
                <p className="text-white">
                  ...
                  So warm and kind.
                  <br />
                  When the world takes aim at the brighter side and it feels
                  like nothing ever changes.
                  <br />
                  Only your smile could last this long, I see you. I see you.
                </p>
                <p className="text-white">
                  Stay for the night, leave for the day, try not to cry, dry
                  your eyes on your sleeve.
                </p>
                <p className="text-white">
                  You don't want to be alright, you don't want to be ok.
                  <br />
                  You don't want to be just fine, at least not their way, not
                  their way.
                </p>
                <p className="text-white">
                ...
                <p className="text-white">
                  ...
                  <br />I don't want to be just fine, at least not their way,
                  not their way.
                </p>
                <p className="text-white">
                  I still believe in love.
              ...
              <div className="p-4">
                ...
                <p className="text-white">
                  Professor I profess, I don't have the answers, I don't have
                  the answers yet, to any of this.
                  <br />
                  And in these halls I can hear their calls past every door and
                  on every floor, I'm hiding from your observation.
                  <br />
                ...
                <p className="text-white">
                  And at your desk I must confess I'm not strong enough yet to
                  take on
                  <br />
                  All that you got wrong.
                  <br />
                  And in a way I could realize that you would have hoped for
                  someone to sail this ship when you are gone.
                </p>
            ...
            <p className="text-white">New song in progress…</p>
              ...
              <div className="p-4">
                <h3 className="text-[#bfb689] font-bold">
                  Oliver at the Bridge
                </h3>
                <p className="text-white">
                  Oliver standing at the bridge, waiting for you to return to
                  this place.
                  <br />
                  I know it's been 100 years, if you return to the place would
                  you still recognize my face?
                  <br />
                ...
                <p className="text-white">
                  ...
                  <br />
                  From a world that keeps on leading you down, the wrong road
                  the wrong way.
                  <br />
                  There's no way out.
                </p>
                <p className="text-white">
                  ...
                  this place.
                  <br />
                  I know it's been 1000 years, if you return to the place would
                  you still recognize my face?
                  <br />
