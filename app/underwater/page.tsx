...
export default function Underwater() {
  return (
    ...
    >
      <div className="w-[90%] mx-auto bg-[#24252d]/70 mt-108 p-20">
  ...
  <p className="text-white">
    I know I know.<br />
    The sky is taken away.<br />
    I know I know.<br />
    I'm to blame, I'm to blame.<br />
    And I don't know what's worse,<br />
    that it was paid for, or that it works.
  </p>
  <p className="text-white">
    Message paid for by someone we don't know.<br />
    It looks like light at night, but it doesn't let go.
  </p>
  <p className="text-white">
    It's cursed, they say it's cursed.<br />
    I don't know if it's real, maybe it's worse
  </p>
  <p className="text-white">
    I know I know.<br />
    The sky is taken away.<br />
...
<div className="p-4">
  ...
  <p className="text-white">
    In the place I used to wait for you.<br />
    At the table. At the table.<br />
    In the place I used to hide from you.<br />
    Under the table.
  </p>
  <p className="text-white">
  ...
  <p className="text-white">
    In this place we used to wait all day.<br />
    At the table. At the table.
  </p>
  <p className="text-white">
    In this place we used to hide away.<br />
    Under the table.
  </p>
  <p className="text-white">
    Needle falls right through, stare at the clock. Stare at the clock.
  </p>
  <p className="text-white">
...
<div className="p-4">
  ...
  <p className="text-white">
    I don't mind, I'll be yours anytime<br />
    That you want me to be there for you<br />
    I'm just a person on your black t-shirt<br />
    That's all I'll ever be, it's all I ever was.<br />
  ...
  <p className="text-white">
    I'm just a person on your black t-shirt.<br />
    If given the choice I'd join you in your world.<br />
    I'd meet you where you live, I'd hold you in real life.<br />
...
<div className="p-4">
  ...
  <p className="text-white">
    Fell in love with the dark side.
  </p>
  <p className="text-white">
    Did your light fade out? I think you figured it out.<br />
    No need to run and hide, they won't come to find you.<br />
...
<div className="p-4">
  ...
  <p className="text-white">
    You don't want to be alright, you don't want to be ok.<br />
  ...
  <p className="text-white">
    I don't want to be alright, I don't want to be ok.<br />
...
<div className="p-4">
  ...
  <p className="text-white">
    Professor I profess, I don't have the answers I don't have the answers yet, to any of this<br />
    And in these halls I can hear their calls past every door and on every floor I'm hiding from your observation<br />
    I'm hiding from your observation
  </p>
  <p className="text-white">
    And so far I haven't caught on yet<br />
    I thought by now that I'd be so much stronger<br />
    And so far I haven't caught on yet<br />
    I thought by now that I'd be so much stronger than I am
  </p>
  <p className="text-white">
    And at your desk I must confess I'm not strong enough yet to take on<br />
...
<div className="p-4">
  ...
  <p className="text-white">
    ...
    I know it's been 100 years if you return to the place would you still recognize my face<br />
    Or would you see the lines and just walk away?<br />
    Would you see the lines and just walk away?
  </p>
  <p className="text-white">
    I see no way, to save you now. From a world that keeps on leading you down, the wrong road the wrong way.<br />
    There's no way out.
  </p>
  <p className="text-white">
    Oliver standing at the bridge waiting for you to return to this place<br />
    I know it's been 1000 years if you return to the place would you still recognize my face<br />
...
<div className="p-4">
  ...
  <p className="text-white">
    ...
    Long after you're gone, I will be here for an eternity<br />
    I'll await your return<br />
